...
Public Class frptpegawai
    ...
    Private Sub frptpegawai_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        penggajian.conect()
        'cryRpt.Load("D:\APLIKASI SPP\SPP\SPP\REPORT\RPT\CetakDSP.rpt")
        cryRpt.Load("D:\VB\Aplikasi Penggajian Guru dan Karyawan YAPINDA\Gaji\RptPegawai.rpt")
